...
class HitAndRunModule : Module("hitandrun", ModuleCategory.Combat) {
    ...
    private var range by floatValue("range", 4.0f, 0f..100f)
    private var hitSpeed by intValue("hit_speed", 200, 0..5000)
    private var jumpHeight by floatValue("jump_height", 0.42f, 0f..10f)
    private var circleRadius by floatValue("circle_radius", 1f, 0f..50f)
